...
const styles = StyleSheet.create({
  ...
  notFoundText: { ...TextStyles.body, color: DarkTheme.text.secondary },
  ...
  desc: { ...TextStyles.body, color: DarkTheme.text.secondary, lineHeight: 26 },
  progressSection: { gap: Spacing.sm },
  progressLabelRow: { flexDirection: 'row', justifyContent: 'space-between' },
  progressLabel: { ...TextStyles.small, color: DarkTheme.text.secondary },
  ...
  metaValue: { ...TextStyles.h4, color: DarkTheme.text.primary },
  metaLabel: { ...TextStyles.caption, color: DarkTheme.text.secondary },
  ...
  milestoneTitle: { ...TextStyles.bodyMedium, color: DarkTheme.text.primary, flex: 1 },
  milestoneTitleDone: { color: DarkTheme.text.secondary, textDecorationLine: 'line-through' },
  checkmark: { color: Colors.accent, fontSize: 16, fontWeight: 'bold' },
  milestoneDue: { ...TextStyles.caption, color: DarkTheme.text.secondary, marginTop: 2 },
  taskRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  taskTitle: { ...TextStyles.small, color: DarkTheme.text.primary },
  ...
  chartLabel: { ...TextStyles.caption, color: DarkTheme.text.secondary },
  ...
  chartDayLabel: { ...TextStyles.caption, color: DarkTheme.text.secondary, flex: 1, textAlign: 'center' },
  spacer: { height: 40 },
});
